  ...
  return (
    ...
    <div className={styles.container} id="about">
      <main className={`${styles.main}`}>        
        ...
        <Reveal animateIn="animate__fadeInUpBig">
          <h1 className={styles.title}>
            Who Am I <span>?</span>
          </h1>
        </Reveal>        

        <Reveal animateIn="animate__bounceInLeft">
        ...
        <Reveal animateIn="animate__bounceInRight">
          <p className={styles.description}>
        ...
        <div className={styles.social}>
          <Reveal animateIn="animate__fadeInBottomLeft">
          ...
          <Reveal animateIn="animate__fadeInBottomRight">            
