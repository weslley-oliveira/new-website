        ...
        <main className={styles.main}>
          ...
          >
            <div className={styles.action}>
              ...
              <a className={styles.actionButton} href="/weslley-oliveira-cv.pdf" download>{t('home.downloadCv')}</a>
              
              <button className={`${styles.actionButton} ${styles.secondaryButton}`} onClick={openModalDisplay}>{t('home.contactMe')}</button>
            </div>
          </Reveal>
        </main>
